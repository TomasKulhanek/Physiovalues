...
function show_nav() {
    ...
    if ($no_computing) {
        echo "
            Physiome@home is a research project that uses volunteers
            to do research in human physiology and the physiome project.
        ";
    } else {
        echo "
            Physiome@home is a research project that uses Internet-connected
            computers to do research in human physiology.
    ...
    echo "
        <p>
        Physiome@home is based at <a href=\"http:\\lf1.cuni.cz\">First Faculty of Medicine, Charles University</a> in Prague 

        <ul>
        <li> <a href=\"http://www.physiovalues.org\">www.physiovalues.org</a> - project to handle physiological relevant values and parameters of models
        <li> This project is maintained at <a href=\"http://patf-biokyb.lf1.cuni.cz\">Laboratory of biocybernetics</a>
        </ul>
